...
**How to resolve:** Grep `/home/REDACTED/myqrlwallet/go-qrl` for `PrecompiledContract` registrations and MLDSA references. Ask QRL core-devs. If missing, open a QIP proposing inclusion before mainnet freeze.
